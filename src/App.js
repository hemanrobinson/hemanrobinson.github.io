    ...
    return (
        <div>
            ...
            <div className="App Two">
                ...
                <ReportCard title="Learnable Zooming"   href="https://hemanrobinson.github.io/zooming-usability/"   img="zooming-usability-small.png" text="An Easily Learned User Interface for Zooming" />
            </div>
            <div className="Description">
                <h2>Inspiration</h2>
                <p>
